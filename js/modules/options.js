...
OSApp.Options.showOptions = function( expandItem ) {
	...
	if ( typeof OSApp.currentSession.controller.options.mas3 !== "undefined" ) {
		...
		list += "<div class='ui-field-contain ui-field-no-border'><label for='o83' class='select'>" +
				OSApp.Language._( "Master Station" ) + " 3" +
			"</label><select data-mini='true' id='o83'><option value='0'>" + OSApp.Language._( "None" ) + "</option>";
		...
		if ( typeof OSApp.currentSession.controller.options.mton3 !== "undefined" ) {
			list += "<div " + ( OSApp.currentSession.controller.options.mas3 === 0 ? "style='display:none' " : "" ) +
				"class='ui-field-no-border ui-field-contain duration-field'><label for='o84'>" +
					OSApp.Language._( "Master On Adjustment" ) +
				"</label><button data-mini='true' id='o84' value='" + OSApp.currentSession.controller.options.mton3 + "'>" + OSApp.currentSession.controller.options.mton3 + "s</button></div>";
		}

		if ( typeof OSApp.currentSession.controller.options.mtof3 !== "undefined" ) {
			list += "<div " + ( OSApp.currentSession.controller.options.mas3 === 0 ? "style='display:none' " : "" ) +
				"class='ui-field-no-border ui-field-contain duration-field'><label for='o85'>" +
					OSApp.Language._( "Master Off Adjustment" ) +
				"</label><button data-mini='true' id='o85' value='" + OSApp.currentSession.controller.options.mtof3 + "'>" + OSApp.currentSession.controller.options.mtof3 + "s</button></div>";
		}
	}
	...
	page.find( "#o18,#o37,#o83" ).on( "change", function() {
		...
		if ( typeof OSApp.currentSession.controller.options.mas3 !== "undefined" ) {
			page.find( "#o84,#o85" ).parents( ".ui-field-contain" ).toggle( parseInt( page.find( "#o83" ).val() ) === 0 ? false : true );
		}
	} );
